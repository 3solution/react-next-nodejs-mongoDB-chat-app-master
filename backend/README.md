...
- **JSX**: for frontend using [ReactJS](https://reactjs.org/).
- **Web Sockets**: for real time chats using [Socket.io](https://socket.io/) 
...
```bash
git clone https://github.com/vedant1202/react-nodejs-chat-app.git
cd react-nodejs-chat-app/backend
```
...
src\
 ...
 |--sockets\        # Web sockets setup and management
...
`GET /v1/messages/{userId}/{toId}` - get messages from a chat room\
`PATCH /v1/messages/:messageId` - update message\
